...
sed -i'' -E "0,/<key>CFBundleShortVersionString<.key><string>[0-9\.a-z-]+<.string>/s//<key>CFBundleShortVersionString<\/key><string>${ver}<\/string>/" _deployment/mac/Gyroflow.app/Contents/Info.plist
sed -i'' -E "0,/Gyroflow v[0-9\.a-z-]+/s//Gyroflow v${ver}/" src/cli.rs
