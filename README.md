...
3. Install dependencies to the `ext` directory: `cd gyroflow/ext`
    - `Qt 6.2.4` or higher: `pip3 install -U pip & pip3 install aqtinstall` then `aqt install-qt windows desktop 6.2.4 win64_msvc2019_64` or use the [official installer](https://www.qt.io/download-qt-installer)
...
2. Install Qt for Android: `aqt install-qt windows android 6.2.4 android_arm64_v8a` and `aqt install-qt windows desktop 6.2.4 win64_mingw`
