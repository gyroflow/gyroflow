...
export FFMPEG_DIR=$PROJECT_DIR/ext/ffmpeg-master-linux-clang-gpl-lite
...
export PATH="$PROJECT_DIR/ext/6.4.2/gcc_64/bin:$FFMPEG_DIR/bin/amd64:$PATH"
export OPENCV_LINK_LIBS="opencv_calib3d4,opencv_features2d4,opencv_imgproc4,opencv_video4,opencv_flann4,opencv_core4"

export LD_LIBRARY_PATH="$PROJECT_DIR/target/release:$PROJECT_DIR/ext/6.4.2/gcc_64/lib:$FFMPEG_DIR/lib:$FFMPEG_DIR/lib/amd64"
