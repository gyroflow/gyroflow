                ...
                Row {
                    ...
                    SplitButton {
                        ...
                        function render(): void {
                            ...
                            const hasMotionDataForClip = ((motionData.item.hasQuaternions && motionData.item.integrationMethod === 0) || motionData.item.hasAccurateTimestamps) && motionData.item.filename == vidInfo.item.filename;
                            if (!hasMotionDataForClip && controller.offsets_model.rowCount() == 0 && !allowSync) {
