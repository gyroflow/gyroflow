...
$QT_LIBS = "$PROJECT_DIR\ext\6.3.0\android_arm64_v8a\lib"
$Env:Path += ";$PROJECT_DIR\ext\6.3.0\android_arm64_v8a\bin"
$Env:Path += ";$PROJECT_DIR\ext\6.3.0\mingw_64\bin\"
...
$Env:QMAKE = "$PROJECT_DIR\ext\6.3.0\android_arm64_v8a\bin\qmake.bat"
...
{
   "description": "",
   "qt": "$PROJECT_DIR_UNIX/ext/6.3.0/android_arm64_v8a",
   "sdk": "$SDK_REPLACED",
   ...
   "qml-importscanner-binary": "$PROJECT_DIR_UNIX/ext/6.3.0/mingw_64/bin/qmlimportscanner",
   "rcc-binary": "$PROJECT_DIR_UNIX/ext/6.3.0/mingw_64/bin/rcc",
