...
if "%2"=="" ( set "QT_DIR=D:\Programy\Qt\6.3.2\msvc2019_64" ) else ( set "QT_DIR=%2" )
...
if "%FFMPEG_DIR%"=="" ( set FFMPEG_DIR=%PROJECT_DIR%\ext\ffmpeg-5.1-windows-desktop-vs2022-gpl-lite )
