...
if "%2"=="" ( set "QT_DIR=D:\Programy\Qt\6.4.3\msvc2019_64" ) else ( set "QT_DIR=%2" )
...
:: Copy ffmpeg
xcopy /Y "%FFMPEG_DIR%\bin\avcodec-60.dll"    "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\avdevice-60.dll"   "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\avfilter-9.dll"    "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\avformat-60.dll"   "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\avutil-58.dll"     "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\swresample-4.dll"  "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\swscale-7.dll"     "%TARGET%\"
...
xcopy /Y "%CARGO_TARGET%\mdk-braw.dll"                                 "%TARGET%\"
xcopy /Y "%CARGO_TARGET%\mdk-r3d.dll"                                  "%TARGET%\"
