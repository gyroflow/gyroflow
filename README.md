...
3. Install dependencies to the `ext` directory: `cd gyroflow/ext`
    - `Qt 6.3.2` or higher: `pip3 install -U pip & pip3 install aqtinstall` then `aqt install-qt windows desktop 6.3.2 win64_msvc2019_64 -m qtshadertools` or use the [official installer](https://www.qt.io/download-qt-installer)
