...
xcopy /Y "%FFMPEG_DIR%\bin\avcodec-58.dll"    "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\avdevice-58.dll"   "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\avfilter-7.dll"    "%TARGET%\"
xcopy /Y "%FFMPEG_DIR%\bin\avformat-58.dll"   "%TARGET%\"
