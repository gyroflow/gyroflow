...
export PATH="$PROJECT_DIR/ext/6.2.4/gcc_64/bin:$FFMPEG_DIR/bin/amd64:$PATH"
export OPENCV_LINK_LIBS="opencv_core,opencv_calib3d,opencv_features2d,opencv_imgproc,opencv_video,opencv_flann"

export LD_LIBRARY_PATH="$PROJECT_DIR/target/release:$PROJECT_DIR/ext/6.2.4/gcc_64/lib:$FFMPEG_DIR/lib:$FFMPEG_DIR/lib/amd64"
