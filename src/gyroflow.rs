...
mod resources_qml;
pub mod ui { pub mod ui_tools; pub mod components { pub mod TimelineGyroChart; pub mod TimelineKeyframesView; pub mod TimelineAudioWaveform; pub mod FrequencyGraph; pub mod Settings; } }
...
use ui::components::TimelineAudioWaveform::TimelineAudioWaveform;
...
fn entry() {
    ...
    qml_register_type::<TimelineAudioWaveform>(cstr::cstr!("Gyroflow"), 1, 0, cstr::cstr!("TimelineAudioWaveform"));
