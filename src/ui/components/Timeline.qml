    ...
    Item {
        ...
        Popup {
            ...
            onClicked: (index) => {
                ...
                switch (index) {
                    case 0: controller.start_autosync(pos, window.sync.initialOffset.value, window.sync.syncSearchSize.value * 1000, window.sync.timePerSyncpoint, window.sync.everyNthFrame, window.videoArea.vid); break;
